...
class MyipTestRunner
{
    ...
    {
        $live = self::getenv('MYIP_TEST_LIVE');
        $override = self::getenv('MYIP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MYIP_TEST_EXPLAIN');
...
class_alias('MyipTestRunner', 'Runner');
class_alias('MyipHelpers', 'Helpers');

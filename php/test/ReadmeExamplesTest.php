...
// Myip SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MyipSDK::test)
...
{
    private const SDK_CLASS = 'MyipSDK';
    ...
    private const SDK_BASE = 'myip_sdk';

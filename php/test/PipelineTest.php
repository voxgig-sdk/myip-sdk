...
require_once __DIR__ . '/../myip_sdk.php';
...
{
    private static function utility(): MyipUtility
    {
        return new MyipUtility();
    }
    ...
    private static function ctx(array $over = []): MyipContext
    {
        ...
        $ctx->op = new MyipOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MyipError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MyipOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MyipMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MyipOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MyipMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MyipOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MyipMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MyipSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MyipMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MyipResponse([]),
            'result' => new MyipResult([]),
        ]);
        [, $err] = MyipMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MyipSpec(['step' => 's']),
            'response' => new MyipResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MyipResult([]),
        ]);
        [, $err] = MyipMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MyipSpec(['step' => 's']),
            'response' => new MyipResponse(self::resp(200, ['v' => 1])),
            'result' => new MyipResult([]),
        ]);
        [, $err] = MyipMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MyipSpec(['step' => 's']),
            'response' => new MyipResponse(self::resp(200, ['v' => 2])),
            'result' => new MyipResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MyipMakeResponse::call($ctx);
    ...
    {
        $preset = new MyipResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MyipSpec([]),
            'response' => new MyipResponse([]),
            'result' => new MyipResult([]),
        ...
        [$got, $err] = MyipMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MyipResult([])]);
        [, $err] = MyipMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MyipSpec([]), 'result' => null]);
        [, $err] = MyipMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MyipSpec(['step' => 's']),
            'result' => new MyipResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MyipOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MyipMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MyipSpec(['step' => 's']),
            'result' => new MyipResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MyipOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MyipMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MyipResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MyipSpec([]),
            'result' => new MyipResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MyipMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $utility = self::utility();
        $boom = new MyipError('boom', 'boom');
        $utility->fetcher = function (MyipContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MyipSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MyipMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MyipContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MyipMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MyipResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MyipContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MyipSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MyipMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MyipResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MyipSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MyipMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MyipMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MyipResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MyipDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MyipResult(['ok' => false])]);
        $this->expectException(MyipError::class);
        MyipDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MyipResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MyipMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MyipBaseFeature();
        $b = new MyipBaseFeature();
        MyipFeatureAdd::call($ctx, $a);
        MyipFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MyipBaseFeature
    {
        $f = new MyipBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    private static function auth_ctx(array $options, ?array $headers): MyipContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MyipSpec(['headers' => $headers]),
        ]);
    }
    ...
    {
        $ctx = self::ctx([
            'response' => new MyipResponse(['headers' => null]),
            'result' => new MyipResult([]),
        ]);
        MyipResultHeaders::call($ctx);

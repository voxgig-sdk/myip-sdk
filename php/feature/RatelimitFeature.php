...
class MyipRatelimitFeature extends MyipBaseFeature
{
    ...
    private function _acquire(MyipContext $ctx): void
    {
    ...
    private function _track(MyipContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

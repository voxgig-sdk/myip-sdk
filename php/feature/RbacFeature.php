...
class MyipRbacFeature extends MyipBaseFeature
{
    ...
    private function _required(MyipContext $ctx): ?string
    {
    ...
    private function _reject(MyipContext $ctx, string $required): void
    {
    ...
    private function _track(MyipContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

...
class MyipStreamingFeature extends MyipBaseFeature
{
    ...
    private function _iterate(MyipResult $result): \Generator
    {
    ...
    private function _streamable(MyipContext $ctx): bool
    {

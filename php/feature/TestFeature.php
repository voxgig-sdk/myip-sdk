...
// Myip SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MyipTestFeature extends MyipBaseFeature
{
    ...
    public function init(MyipContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MyipContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MyipContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MyipContext $ctx, $op, $args): array
    {

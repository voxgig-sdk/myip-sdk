...
MyipSDK._make_feature = _make_feature


function MyipSDK.new(options)
  local self = setmetatable({}, MyipSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function MyipSDK:get_utility()
  return Utility.copy(self._utility)
end


function MyipSDK:get_root_ctx()
  return self._rootctx
end


function MyipSDK:prepare(fetchargs)
...
function MyipSDK:direct(fetchargs)
...
-- by passing it.
function MyipSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function MyipSDK:graphql(query, variables, ctrl)
...
function MyipSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}

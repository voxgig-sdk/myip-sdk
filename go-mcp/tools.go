...
func registerTools(server *mcp.Server, client *sdk.MyipSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "myip_list",
		Description: "List records from Myip. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "myip_load",
		Description: "Load a single record from Myip. " +
...
func runOp(client *sdk.MyipSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MyipSDK, name string) (sdk.MyipEntity, error) {

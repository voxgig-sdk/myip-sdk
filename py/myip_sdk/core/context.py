...
from myip_sdk.core.helpers import get_ctx_prop, to_map
...
class MyipContext:
    ...
    def make_error(self, code, msg):
        return MyipError(code, msg, self)

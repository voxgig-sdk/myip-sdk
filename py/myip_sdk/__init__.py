...
from myip_sdk.utility import register
...
class MyipSDK:
    ...
    def get_utility(self):
        return MyipUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MyipSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetIpInfo(self, data=None) -> "GetIpInfoEntity":
        ...
        from myip_sdk.entity.get_ip_info_entity import GetIpInfoEntity
        return GetIpInfoEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MyipSDK":
        if sdkopts is None:
            sdkopts = {}

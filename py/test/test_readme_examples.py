# Myip SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MyipSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MyipSDK(...) and MyipSDK.test(...) become
#      MyipSDK.test({"entity": {...}}) seeding one mock record (id "test01")

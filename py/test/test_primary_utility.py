...
from myip_sdk.core.response import MyipResponse
from myip_sdk.core.operation import MyipOperation
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = MyipSDK.test(None, None)
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MyipBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MyipSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MyipSDK.test(None, setup_opts)

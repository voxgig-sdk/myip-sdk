# Myip Golang SDK Reference

Complete API reference for the Myip Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *MyipSDK`
...
#### `GetIpInfo(data map[string]any) MyipEntity`
...
| `hosting_info` | `map[string]any` | No |  |
| `ip` | `string` | No |  |
| `ipv4` | `string` | No |  |
| `ipv6` | `string` | No |  |

...
class MyipTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MyipTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = MyipTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = MyipTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

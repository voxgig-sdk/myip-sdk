...
class MyipTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MyipTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = MyipTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = MyipTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")

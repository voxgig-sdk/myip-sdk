...
class MyipNetsimFeature extends MyipBaseFeature
{
    ...
    private function _simulate(MyipContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MyipContext $ctx, array $applied): void
    {
        $client = $this->client;

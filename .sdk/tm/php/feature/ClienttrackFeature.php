...
class MyipClienttrackFeature extends MyipBaseFeature
{
    ...
    public function PostConstruct(MyipContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Myip-SDK';

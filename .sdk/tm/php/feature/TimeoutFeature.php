...
class MyipTimeoutFeature extends MyipBaseFeature
{
    ...
    private function _with_timeout(MyipContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MyipContext $_ctx, float $ms): void
    {
        $client = $this->client;

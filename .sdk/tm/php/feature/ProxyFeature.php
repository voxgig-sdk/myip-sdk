...
class MyipProxyFeature extends MyipBaseFeature
{
    ...
    public function init(MyipContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MyipContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

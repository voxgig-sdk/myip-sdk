...
class MyipCacheFeature extends MyipBaseFeature
{
    ...
    private function _through(MyipContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

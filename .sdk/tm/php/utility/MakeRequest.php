...
// Myip SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MyipMakeRequest
{
    public static function call(MyipContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MyipResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MyipResponse($fetched);
        } else {

...
class MyipFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MyipSDK/1.0)';
    ...
    public static function call(MyipContext $ctx, string $fullurl, array $fetchdef): array
    {

...
module MyipTestRunner
  ...
  def self.env_override(m)
    live = getenv("MYIP_TEST_LIVE")
    override = getenv("MYIP_TEST_OVERRIDE")
    ...
    explain = getenv("MYIP_TEST_EXPLAIN")
    m["MYIP_TEST_EXPLAIN"] = explain if explain && !explain.empty?
